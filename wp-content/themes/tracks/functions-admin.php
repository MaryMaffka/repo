...
function ct_tracks_customize_register_logo( $wp_customize ) {
	...
	$wp_customize->add_section(
		'ct-upload',
		array(
			'title'      => esc_html__( 'Логотип', 'tracks' ),
			'priority'   => 60,
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			$wp_customize, 'logo_image',
				array(
					'label'    => esc_html__( 'Добавить свой логотип.', 'tracks' ),
					'section'  => 'ct-upload',
    ...
    <table class="form-table">
        ...
        <?php
        	foreach($social_sites as $key => $social_site) {
        		...
        		<tr>
					<td>
						<label for="<?php echo $key; ?>-profile"><?php echo ucfirst($key); ?> Профили:</label>
					</td>
					<td>
